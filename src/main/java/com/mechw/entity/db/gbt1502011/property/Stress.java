...
@Entity
@Table(name = "stress", catalog = "gbt_150_2011")
public class Stress {
    ...
    // 最小厚度
    @Column(name = "stress_thk_min")
    private Double stressThkMin;

    // 最大厚度
    @Column(name = "stress_thk_max")
    private Double stressThkMax;

    // 最小温度
    @Column(name = "stress_temp_min")
    private Double stressTempMin;

    // 最大温度
    @Column(name = "stress_temp_max")
    private Double stressTempMax;
    ...
    public Stress(Double index, Double no, String std, String name, Double stressThkMin, Double stressThkMax, Double stressTempMin, Double stressTempMax, Double p20, Double p40, Double p50, Double p65, Double p75, Double p100, Double p125, Double p150, Double p175, Double p200, Double p225, Double p250, Double p275, Double p300, Double p325, Double p350, Double p375, Double p400, Double p425, Double p450, Double p475, Double p500, Double p525, Double p550, Double p575, Double p600, Double p625, Double p650, Double p675, Double p700, Double p725, Double p750, Double p775, Double p800, Double p850, Double p900, Double tagStress, Double highLow) {
        this.index = index;
        this.no = no;
        this.std = std;
        this.name = name;
        this.stressThkMin = stressThkMin;
        this.stressThkMax = stressThkMax;
        this.stressTempMin = stressTempMin;
        this.stressTempMax = stressTempMax;
        this.p20 = p20;
        this.p40 = p40;
        this.p50 = p50;
        this.p65 = p65;
    ...
    public Map<Double, Double> toMap() {
        ...
        if (this.p20 != null) {
            stressMap.put(20.0, p20);
        }
        if (this.p40 != null) {
            stressMap.put(40.0, p40);
        }
        if (this.p50 != null) {
            stressMap.put(50.0, p50);
        }
        if (this.p65 != null) {
            stressMap.put(65.0, p65);
        }
        if (this.p75 != null) {
            stressMap.put(75.0, p75);
        }
        if (this.p100 != null) {
    ...
    public Double getStressThkMin() {
        return stressThkMin;
    }

    public void setStressThkMin(Double stressThkMin) {
        this.stressThkMin = stressThkMin;
    }

    public Double getStressThkMax() {
        return stressThkMax;
    }

    public void setStressThkMax(Double stressThkMax) {
        this.stressThkMax = stressThkMax;
    }

    public Double getStressTempMin() {
        return stressTempMin;
    }

    public void setStressTempMin(Double stressTempMin) {
        this.stressTempMin = stressTempMin;
    }

    public Double getStressTempMax() {
        return stressTempMax;
    }

    public void setStressTempMax(Double stressTempMax) {
        this.stressTempMax = stressTempMax;
    }
