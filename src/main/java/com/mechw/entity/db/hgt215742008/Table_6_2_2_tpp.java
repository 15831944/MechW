...
@Entity
@Table(name = "table_6_2_2_tpp", catalog = "hgt_21574_2008")
public class Table_6_2_2_tpp {
    ...
    public Table_6_2_2_tpp() {
    }

    public Table_6_2_2_tpp(Integer lineNo, Float dn, Float distance, Float liftWeight, String type, Float shellMin, Float padMin) {
        this.lineNo = lineNo;
        this.dn = dn;
