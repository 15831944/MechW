...
@Entity
@Table(name = "table_9_2_2_axc", catalog = "hgt_21574_2008")
public class Table_9_2_2_axc {
    ...
    public Table_9_2_2_axc() {
    }

    public Table_9_2_2_axc(Integer lineNo, Float shellDN, Float liftWeight, String type, Float lugDN, Float shellMinTHK, Float padTHK) {
        this.lineNo = lineNo;
