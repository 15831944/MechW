...
@Entity
@Table(name = "table_6_2_1", catalog = "hgt_21574_2008")
public class Table_6_2_1 {
    ...
    public Table_6_2_1(Integer lineNo, String norm, Float liftWeightMin, Float liftWeightMax, Float dnMin, Float dnMax, Float s, Float d, Float l, Float r, Float ltp, Float htp, Float lugWeight, Float padWeightFactor) {
        this.lineNo = lineNo;
        this.norm = norm;
