...
@Entity
@Table(name = "table_a_1", catalog = "gbt_706_2016")
public class Table_a_1 {
    ...
    public Table_a_1(Double lineNo, String norms, String type, Double h, Double b, Double d, Double t, Double r, Double r1, Double sectionArea, Double mass, Double outerArea, Double bix, Double biy, Double six, Double siy, Double wx, Double wy, Double z0) {
        this.lineNo = lineNo;
        this.norms = norms;
        this.type = type;
        this.h = h;
