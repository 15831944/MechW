...
@Entity
@Table(name = "rel_steel_high_alloy", catalog = "nbt_47003_1_2009")
public class RelHighAlloy {
    ...
    public RelHighAlloy(Double no, String type, String std, String name, Double min, Double max, Double p20, Double p100, Double p150, Double p200, Double p250, Double p300, Double p350) {
        this.no = no;
        this.type = type;
        this.std = std;
        this.name = name;
