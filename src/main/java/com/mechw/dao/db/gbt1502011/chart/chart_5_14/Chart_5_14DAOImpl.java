package com.mechw.dao.db.gbt1502011.chart.chart_5_14;
...
@Transactional
@Repository("Chart_5_14DAO")
public class Chart_5_14DAOImpl implements Chart_5_14DAO {
    ...
    public double getQ2(Double alpha, Double thkrs) {
        ...
        // 获取半顶角数组 alphas
        NativeQuery query_alpha = this.getSession().createNativeQuery("SELECT DISTINCT alpha FROM gbt_150_2011.chart_5_14");
        ...
        if (Array.isContains(alphas, alpha)) {
            ...
            NativeQuery query_thkRs = this.getSession().createNativeQuery(
                    "SELECT DISTINCT thkrs FROM gbt_150_2011.chart_5_14 WHERE alpha=:alpha_param");
            ...
            if (Array.isContains(thkRss, thkRsDB)) {
                String sql_1 = "SELECT q2 FROM gbt_150_2011.chart_5_14 " +
            ...
            // thkrs 需要插值
                ...
                String sql_2 = "SELECT q2 FROM gbt_150_2011.chart_5_14 " +
                        "WHERE alpha=:alpha_param " +
                        "AND thkrs = :thkrs_param";
                ...
                String sql_3 = "SELECT q2 FROM gbt_150_2011.chart_5_14 " +
                        "WHERE alpha=:alpha_param " +
                        "AND thkrs = :thkrs_param";
