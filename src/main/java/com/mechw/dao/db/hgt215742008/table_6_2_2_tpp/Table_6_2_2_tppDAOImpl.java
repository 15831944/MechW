...
@Transactional
@Repository("Table_6_2_2_tppDAO")
public class Table_6_2_2_tppDAOImpl implements Table_6_2_2_tppDAO {
    ...
    public List<Float> listDN() {
        String sql = "SELECT DISTINCT dn FROM hgt_21574_2008.table_6_2_2_tpp";
    ...
    public List<String> findTypesByDNAndLiftWeight(Float dn, Float liftWeight) {
        ...
        String sqls = "SELECT DISTINCT type FROM hgt_21574_2008.table_6_2_2_tpp WHERE dn= :category_dn AND lift_weight>= :category_liftWeight";
    ...
    public Table_6_2_2_tpp findByDNAndLiftWeightAndType(Float dn, Float liftWeight, String type) {
        ...
        String sqls = "SELECT * FROM hgt_21574_2008.table_6_2_2_tpp WHERE dn= :category_dn AND lift_weight>= :category_liftWeight AND type= :category_type";
        NativeQuery querys = this.getSession().createNativeQuery(sqls).addEntity(Table_6_2_2_tpp.class);
        querys.setParameter("category_dn", dn)
                .setParameter("category_liftWeight", liftWeight)
                .setParameter("category_type", type);
        List<Table_6_2_2_tpp> results = querys.list();
        ...
        if (results.size() <= 0) {
            ...
            int i = 0;
            for (Table_6_2_2_tpp tp : results) {
            ...
            String sql = "SELECT * FROM hgt_21574_2008.table_6_2_2_tpp WHERE dn= :category_dn AND lift_weight= :category_liftWeight AND type= :category_type";
            NativeQuery query = this.getSession().createNativeQuery(sql).addEntity(Table_6_2_2_tpp.class);
            query.setParameter("category_dn", dn)
                    .setParameter("category_liftWeight", Array.min(liftWeightArray))
                    .setParameter("category_type", type);
            return (Table_6_2_2_tpp) query.list().get(0);
