...
public class AXBCResult {
    ...
    public AXBCResult(String type, Float lugDN, Float liftWeight, Float liftWeightMin, Float liftWeightMax, Float shellDN, Float shellDNMin, Float shellDNMax, Float t, Float d0, Float d1, Float d2, Float l, Float s, Float s2, Float u, Float w1, Float shellMinTHK, Float padTHK) {
        this.type = type;
        this.lugDN = lugDN;
