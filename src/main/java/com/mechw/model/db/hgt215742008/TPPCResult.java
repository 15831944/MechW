...
public class TPPCResult {
    ...
    public TPPCResult(float dn, float distance, float liftWeight, String type, float shellMin, float padMin, float s, float d, float l, float r, float ltp, float htp, float lugWeight, float padWeightFactor) {
        this.dn = dn;
