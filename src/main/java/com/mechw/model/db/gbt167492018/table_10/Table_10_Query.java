package com.mechw.model.db.gbt167492018.table_10;

/**
 * @Description 表 10 查询入参模型
 * @Author lishaoyan@mechw.com
 * @Date 2018/11/6 16:41
 * @Version 1.0
 */
public class Table_10_Query {

    private Double rm2h;

    private Double rm182dmtp;

    public Table_10_Query() {
    }

    public Table_10_Query(Double rm2h, Double rm182dmtp) {
        this.rm2h = rm2h;
