...
public class ZZHBDocx {
    ...
    public ZZHBDocx(String ribbonName, Double dout, Double thk, Double dm, Double sh, Double n, Double density, Double theta, Double l, Double lf, Double a, Double bh, Double lt, Double at, Double vt, Double ah, Double w, Double vb) {
