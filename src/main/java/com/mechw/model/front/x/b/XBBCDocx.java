...
public class XBBCDocx {
    ...
    public XBBCDocx(String ribbonName, Double t, Double h0, Double d0, Double ds0, Double m0, Double q0, Double fi, String eq, String stds, String names, Double n, String norms, Double bb, Double hf, Double tf1, String stdb, String nameb, String normb, Double nbt, Double cb2, String stdd, String named, Double cd2, Double thkdn, Double d1, Double d2, Double h, Double hc, Double oc1allow, Double ostallow, Double rstel, Double est, Double sh, Double sb, Double d, Double tm, Double a, Double densitys, Double ao, Double ixx, Double iyy, Double wmin, Double z0, Double densityb, Double obtallow, Double densityd, Double cd1, Double odtallow, Double pw, Double alphae, Double g, Double pe, Double fh, Double w1, Double r, Double db, Double fl1, Double fl2, Double imin, Double ih, Double lamuda, Double lamudah, Double ns, Double eta, Double ocrallow, Double oc, String occhk, Double tau, Double tauallow, String tauchk, Double l1, Double e, Double ob, Double oballow, String obchk, String totalchk, Double dmin, Double abt, Double obt, String obtchk, Double taubt, Double taubtallow, String taubtchk, Double oc1, String oc1chk, Double thkdc, Double thkdd, String thkdchk, Double fai, Double ballow, Double hf1, Double z, Double of, String ofchk, Double af, Double tauf, String taufchk, Double ot, String otchk) {
