...
public class BCFPDocx {
    ...
    public BCFPDocx(String ribbonName, Double t, Double pd, Double ps, String std, String name, Double dc, Double thkn, Double c2, Double e, String test, Double d, Double rel, Double c1, Double ot, Double o, Double pc, Double kp, Double c, Double thke, Double thkc, Double thkd, String thkchk, Double pt, Double mawp) {
