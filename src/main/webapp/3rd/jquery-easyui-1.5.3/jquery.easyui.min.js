...
var a=$("<a></a>").addClass(icon).appendTo(c);
a.bind("click",_233);
};
function _22d(){
if(opts.footer){
...
var tab=$("<li>"+"<a class=\"tabs-inner\">"+"<span class=\"tabs-title\"></span>"+"<span class=\"tabs-icon\"></span>"+"</a>"+"</li>");
if(!pp){
pp=$("<div></div>");
}
...
if(!t.length){
t=$("<a></a>").addClass(_3c6).appendTo(tool);
...
bc.append("<a class=\"textbox-icon "+bb[i].iconCls+"\" icon-index=\""+i+"\" tabindex=\"-1\"></a>");
}
}
tb.find(".textbox-button").remove();
if(opts.buttonText||opts.buttonIcon){
var btn=$("<a class=\"textbox-button\"></a>").prependTo(tb);
...
_610.append("<a class=\"spinner-arrow-up\" tabindex=\"-1\"></a>");
_610.append("<a class=\"spinner-arrow-down\" tabindex=\"-1\"></a>");
}else{
var _611=$("<a class=\"textbox-button spinner-button\"></a>").addClass(opts.clsLeft).appendTo(_607.spinner);
var _612=$("<a class=\"textbox-button spinner-button\"></a>").addClass(opts.clsRight).appendTo(_607.spinner);
...
$("<a class=\"tagbox-remove\"></a>").appendTo(_b57);
});
_b58(_b4c);
...
var t=$("<a class=\"datebox-button-a\"></a>").html($.isFunction(btn.text)?btn.text(_b8e):btn.text).appendTo(td);
...
(function($){
function init(_bd4){
var _bd5=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_bd4);
var t=$(_bd4);
...
_be8.html("<a class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_be8.append("<a class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
